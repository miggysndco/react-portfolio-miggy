...
const Data = () => {
  return (
    <div className="home_data">
        ...
        <p className="home_description">I'm a web developer with a passion for crafting digital experiences. 
              With a background in front-end and back-end development, 
              I thrive in creating user-friendly and responsive websites that 
              not only look great but also function seamlessly.
              Let's collaborate to bring your web project to life!</p>
